...
export class StockController {
  ...
  async castFlow(@Query() q: StockOrderDto, @Res() res: Response) {
    try {
      const data = await this.stockService.castFlow(q.stock, +q.order)
      return res.status(HttpStatus.OK).send(new BaseResponse({ data }));
    } catch (e) {
      throw new CatchException(e)
    }
  ...
  async financialIndicators(@Query() q: StockDto, @Res() res: Response) {
    try {
      const data = await this.stockService.financialIndicators(q.stock)
      return res.status(HttpStatus.OK).send(new BaseResponse({ data }));
    } catch (e) {
      throw new CatchException(e)
    }
  ...
  async enterprisesSameIndustry(@Query() q: EnterprisesSameIndustryDto, @Res() res: Response) {
    try {
      const data = await this.stockService.enterprisesSameIndustry(q.stock, q.exchange)
      return res.status(HttpStatus.OK).send(new BaseResponse({ data }));
    } catch (e) {
      throw new CatchException(e)
    }
