...
CONFIG_ARGS="s|CONFIG_NODE_ENV|${CONFIG_NODE_ENV}|g;\
			...
			s|CONFIG_MSSQL_HOST2|${CONFIG_MSSQL_HOST2}|g;\
        	s|CONFIG_MSSQL_PORT2|${CONFIG_MSSQL_PORT2}|g;\
        	s|CONFIG_MSSQL_USERNAME2|${CONFIG_MSSQL_USERNAME2}|g;\
        	s|CONFIG_MSSQL_PASSWORD2|${CONFIG_MSSQL_PASSWORD2}|g;\
